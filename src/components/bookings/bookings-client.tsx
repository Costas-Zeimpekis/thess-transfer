...
export default function BookingsClient({
	...
	function handleExport() {
		...
		const rows = sortedList.map((b) => ({
			...
			"Ημερομηνία Έναρξης": b.startTime ? new Date(b.startTime).toLocaleString("el-GR", { day: "2-digit", month: "2-digit", year: "numeric", hour: "2-digit", minute: "2-digit", hour12: false }) : "",
			"Ημερομηνία Λήξης": b.endTime ? new Date(b.endTime).toLocaleString("el-GR", { day: "2-digit", month: "2-digit", year: "numeric", hour: "2-digit", minute: "2-digit", hour12: false }) : "",
	...
	const colDefs: Record<string, {
		...
		startTime: {
			...
			head: <>Ημερομηνία Έναρξης</>,
			cell: (b) => <TableCell className="whitespace-nowrap text-sm">{b.startTime ? new Date(b.startTime).toLocaleString("el-GR", { day: "2-digit", month: "2-digit", year: "numeric", hour: "2-digit", minute: "2-digit", hour12: false }) : "—"}</TableCell>,
			skeleton: <TableCell><Skeleton className="h-4 w-28" /></TableCell>,
		},
		endTime: {
			headClass: "font-extrabold",
			head: <>Ημερομηνία Λήξης</>,
			cell: (b) => <TableCell className="whitespace-nowrap text-sm">{b.endTime ? new Date(b.endTime).toLocaleString("el-GR", { day: "2-digit", month: "2-digit", year: "numeric", hour: "2-digit", minute: "2-digit", hour12: false }) : "—"}</TableCell>,
			skeleton: <TableCell><Skeleton className="h-4 w-28" /></TableCell>,
		},
		assignment: {
			headClass: "font-extrabold cursor-pointer select-none",
