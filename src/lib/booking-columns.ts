...
export const DEFAULT_BOOKING_COLUMNS: BookingColumn[] = [
	...
	{ key: "source", label: "Πηγή", visible: true },
	{ key: "arrivalDatetime", label: "Ημ/νία Άφιξης", visible: true },
	{ key: "startTime", label: "Ημερομηνία Έναρξης", visible: true },
	{ key: "endTime", label: "Ημερομηνία Λήξης", visible: true },
...
const LS_KEY = "booking_columns_v3";
